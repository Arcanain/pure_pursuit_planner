...
def generate_launch_description():
    ...
    auto_sound_config_path = os.path.join(
        get_package_share_directory(auto_sound_package),
        'config',
        'params.yaml'
    )
    ...
    auto_sound_node = Node(
        package=auto_sound_package,
        executable='auto_sound',
        output="screen",
        parameters=[auto_sound_config_path]
    )
